...
import { a as experience, c as projectFilters, d as skillGroups, f as whatIBring, i as cn, l as projects, n as SiteShell, o as heroBadges, r as aboutBody, s as profile, t as Button, u as scrollToId } from "./site-shell-enEm4vrT.mjs";
import { t as useReducedMotion } from "../_libs/framer-motion+[...].mjs";
import { t as motion } from "../_libs/motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-B2iHvce2.js
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: projectFilters.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: cn("min-h-10 rounded-full px-4 text-sm transition-colors duration-150", filter === item ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:text-foreground"),
						children: item
					}, item))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: skillGroups.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: cn("min-h-10 shrink-0 rounded-full px-4 text-sm transition-colors duration-150", groupId === item.id ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:text-foreground"),
							children: item.title
						}, item.id))
					})
				}),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: group?.items.map((skill) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								className: cn("min-h-10 rounded-full px-3.5 text-sm transition-colors duration-150", selected ? "bg-accent text-accent-foreground" : "bg-muted text-foreground hover:bg-secondary"),
								children: skill.name
							}, skill.name);
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
